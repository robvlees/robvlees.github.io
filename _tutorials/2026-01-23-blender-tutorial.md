...
tags:
  ...
  - modeling
  - creative-tools
summary: Learn the fundamentals of Blender 3D modeling, from basic tools to creating your first 3D scene. This tutorial covers the basics of 3D modeling in Blender including interface navigation and creating simple shapes.
---
...
1. Visit the official Blender website at [blender.org](https://www.blender.org/)
...
1. **Vertices** - Points that define the shape
...
2. **Move** the object using `G` key (Grab tool)
3. **Rotate** the object using `R` key (Rotate tool)
4. **Scale** the object using `S` key (Scale tool)
