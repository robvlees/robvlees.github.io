...
Gem::Specification.new do |spec|
  ...
  spec.files         = `git ls-files -z`.split("\x0").select { |f| f.match(%r!^(assets|_layouts|_includes|_sass|_posts|blog|_tutorials|tutorial|LICENSE|README|package|node_modules|favicon)!i) }
